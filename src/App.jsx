...
of art, design and technology.</p>
        ...
        <section id='section-2'>
          <div className="titles">
            ...
            <div img-title="navy-pier" className="title">
              ...
              <h1>Navy Pier</h1>
            </div><div img-title="msi-chicago" className="title">
              <small>2015 - TODAY</small>
              <h1>MSI Chicago</h1>
            </div><div img-title="phone"className="title">
              <small>2016</small>
              <h1>This Was Lousise's Phone</h1>
            </div><div img-title="kikk"className="title">
              <small>2012 - TODAY</small>
              <h1>KIKK Festival 2018</h1>
            </div><div img-title="kennedy"className="title">
              <small>2017</small>
              <h1>The Kenned Center</h1>
            </div><div img-title="opera"className="title">
        ...
        <section id='section-3'>
          <div className="top">
            <div className="left">
              <h3>We're crafting <br /> emotional <br />experiences aimed
               <br />at improving <br /> result</h3>
            </div>
            <div className="right"></div>
          </div>
          <div className="bottom">
            <div className="left"></div>
            <div className="right">
              <p>Dogstudio is a design & <br />technology firm working globally <br /> from our offices based in <br />Belgium and chicago <br />
                    Our strong focus on producing <br />high quality & emotional <br /> brandings, 
                     digital products and <br />experiences became a signature.</p>
                <p>We’re passionate about moving <br /> people and solving problems for <br />the likes of Microsoft, The <br />Museum of Science And Industry <br />Of Chicago,
                   The Kennedy Center <br />of Washington, Dragone, Quanta <br /> Magazine, and many more.</p>
            </div>
          </div>
        </section>
      </main>
